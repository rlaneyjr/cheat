...
Available Commands:
  tls-check   Check whether TLS setting are matching between authentication policy and destination rules
...
Use "istioctl authn [command] --help" for more information about a command.
